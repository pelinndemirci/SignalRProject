...
namespace SignalRWebUI.Controllers
{
	public class DiscountController : Controller
	{
		...
		public async Task<IActionResult> Index()
		{
			...
			var responeseMessage = await client.GetAsync("https://localhost:7001/api/Discount");
		...
		{
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.GetAsync($"https://localhost:7001/api/Discount/ChangeStatusToTrue/{id}");
			return RedirectToAction("Index");
		}
		...
		{
			var client = _httpClientFactory.CreateClient();
			var responseMessage = await client.GetAsync($"https://localhost:7001/api/Discount/ChangeStatusToFalse/{id}");
			return RedirectToAction("Index");
		}
	}
}
