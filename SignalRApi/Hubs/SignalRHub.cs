...
namespace SignalRApi.Hubs
{
	public class SignalRHub:Hub
	{
        ...
        public async Task SendStatistic()
		{
			...
			var value3 = _categoryService.TActiviteCategoryCount();
		...
		public async Task SendProgress()
		{
            ...
            var value9 = _productService.TProductBySteakBurger();
            await Clients.All.SendAsync("ReceiveProductBySteakBurger", value9);
